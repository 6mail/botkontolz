let handler  = async (m, { conn, args }) => {
 const ftoko = { key : { fromMe: false, participant : `0@s.whatsapp.net` },message: {orderMessage: { message: `Bot Ini Menggunakan Script base nurutomo bisa kunjungi saja di githubnya langsung `,thumbnail: fs.readFileSync("./src/logo.jpg")}}}
